...
import { ButtonDocument } from './styles';
...
export default class Timeline extends PureComponent {
  ...
  _renderDetail(rowData, rowID) {
     if (rowData.linkText === 'null')
      rowData.linkText = '';
    
    function handleMessage() {
      showMessage({
        message: 'Documento não encontrado',
        description: 'Não existe documento para o reembolso selecionado',
        type: 'warning',
        position: 'top',
      });
    }
    ...
    return (
      <View style={styles.container}>
        ...
        { rowData.linkText 
          ? <ButtonDocument color_suspicions={rowData.color_suspicions} onPress={() => Linking.openURL(rowData.linkUrl)}>
              <Text style={[styles.textTimeline]}> 
                Ver documento
              </Text> 
            </ButtonDocument>
          : <ButtonDocument color_suspicions={rowData.color_suspicions} onPress={() => handleMessage()}>
              <Text style={[styles.textTimeline]}> 
                Ver documento
              </Text> 
            </ButtonDocument>
